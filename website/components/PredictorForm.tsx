  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <select
          className="w-full bg-charcoal/50 border border-electric/20 rounded-lg px-4 py-2 text-offwhite focus:outline-none focus:border-electric"
          onChange={(e) => {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-charcoal/50 border border-electric/20 rounded-lg px-4 py-3 text-offwhite focus:outline-none focus:border-electric"
      ...
      {/* Result Card */}
      {result && (
        <div className="mt-8 bg-charcoal/50 border border-electric/20 rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-2xl font-bold text-electric">Prediction Result</h3>
            <div className="flex space-x-2">
              <button
                onClick={() => exportResult('json')}
                className="px-4 py-2 bg-electric/20 hover:bg-electric/30 text-electric rounded-lg text-sm transition-colors"
              >
                Export JSON
              </button>
              <button
      ...
      <div className="mt-8">
        <button
          ...
          className="w-full bg-charcoal/50 border border-electric/20 rounded-lg px-4 py-3 text-left flex items-center justify-between hover:border-electric/40 transition-colors"
        >
          <span className="font-semibold text-electric">Model Details</span>
          <svg
            className={`w-5 h-5 text-electric transition-transform ${showModelDetails ? 'rotate-180' : ''}`}
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        {showModelDetails && (
          <div className="mt-4 bg-charcoal/50 border border-electric/20 rounded-lg p-6 space-y-4">
            <div>
